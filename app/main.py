...
#from app.services.deviation.incident.incident_router import incident_router





# Register and include incident, incident_modify, and impact assessment routers
from app.services.deviation.incident import incident_router
from app.services.deviation.incident_modify import incident_modify_router
from app.services.deviation.impact_assessment import impact_assessment_route

# Register incident routes (function-based)
if hasattr(incident_router, 'register_incident_routes'):
    incident_router.register_incident_routes(router)

# Include the incident_modify router if it exposes a router object
if hasattr(incident_modify_router, 'router'):
    app.include_router(incident_modify_router.router)

# Register impact assessment routes (if function-based)
if hasattr(impact_assessment_route, 'register_impact_assessment_routes'):
    impact_assessment_route.register_impact_assessment_routes(app)
...
# Include the main router and incident router in the app
app.include_router(router)

# Include the incident router if it exposes a router object
if hasattr(incident_router, 'router'):
